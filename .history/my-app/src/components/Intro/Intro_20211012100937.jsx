...
import Me from  "../../image/henry1.jpg";
    ...
    return (
        <div className="intro">
            ...
            <div className="intro-right">
                ...
                <img src="https://cdnmedia.thethaovanhoa.vn/Upload/H4YRO1ZUXG5fDnj99Lhg/files/%E1%BA%A2nh%20trong%20b%C3%A0i/BTOB-Sungjae.jpg" alt="img" className="intro-img"/>
            </div>
        </div>
    )
}
