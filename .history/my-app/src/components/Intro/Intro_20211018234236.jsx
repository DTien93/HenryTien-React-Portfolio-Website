        ...
        <div className="intro">
            <div className="intro-left">
                <div className="intro-left__wrapper">
                    ...
                    <h2 className="intro-name">Henry Tien</h2>
            ...
            <div className="intro-right">
                ...
                <img src="https://images.pexels.com/photos/3585047/pexels-photo-3585047.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" alt="" className="intro-img" />
            </div>
        </div>
    )
}
