      ...
      <div className="about">
        ...
        <div className="about-right">
          ...
          <p className="about-desc">
            <b style={{ color: 'green'}}>Education:</b> Quy Nhon Universty<br />
            <b style={{ color: 'green'}}>Major:</b> Information Technology <br/>
            <b style={{ color: 'green'}}>Graduate</b> : Rather
          </p>
          <div className="about-award">
            <div className="about-award-texts">
              ...
              <br/>
              <h4 className="about-award-title">Skill</h4>
              <p className="about-award-desc">
